    ...
    <>
      <header 
        className={cn(
          ...
          isScrolled ? "bg-white/90 header-blur shadow-sm py-3" : "bg-transparent py-4"
        )}
      >
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <button 
                ...
                className="mr-4 icon-button p-1 focus:outline-none"
                aria-label="Open menu"
              >
                <Menu className="w-6 h-6" />
              </button>
              <Link to="/search" className="icon-button p-1">
